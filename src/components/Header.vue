            ...
            <div class="container">
                <div class="p-header-content navbar navbar-expand flex-column flex-xl-row justify-content-start justify-content-xl-between align-items-start align-items-xl-center">
                    ...
                    <router-link to="/" tag="a" class="p-header-logo p-svg" exact>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120.5 27">
                            <path fill="#FFFFFF" d="M16,0h5.9v26.8H16v-11H5.9v11H0V0h5.9v10.4H16V0z M26.5,5.8h7.6v21H40v-21h7.6V0H26.5V5.8z M114.7,6.2
	l-4.9,13.2L105,6.2h-6l8.1,20.6h5.4l8-20.6H114.7z M75.9,13.4c0,3.2-1.4,6.8-4.2,9.8c-3.4,3.5-8,3.6-8,3.6H52.1V0h11.6
	c0,0,4,0.2,7.7,3.2C74.7,5.9,75.9,10.6,75.9,13.4z M70.1,13.6c0-2.2-0.9-4.7-2.4-6.1c-1.7-1.6-4-1.7-4-1.7H58v15.5h5.7
	c0,0,1.9,0,3.9-1.8C69.1,18.1,70.1,15.6,70.1,13.6z M97.8,10.9c1.8,3.8,1.2,7.3,1.2,7.3H83.1c0,0,0.3,4.3,5.5,4.3
	c3.5,0,4.5-2.5,4.5-2.5h5.5c0,0-2.2,7-9.8,7c-6.1,0-10.7-4-10.7-10.5c0-6.9,4.5-10.7,10.2-10.7C92.8,5.8,96.1,7.6,97.8,10.9z
	 M93.7,14.4c0,0-0.7-4-5.3-4c-4.7,0-5.3,4-5.3,4H93.7z"/>
                        </svg>
                    </router-link>
